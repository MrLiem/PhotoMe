  ...
  return (
    <Fragment>
      ...
      <main data-test="page-home" className="home-page grid">
        {/* Nếu ko có feedPosts cũng như ko có gì để fetching thì gợi ý user follow user khác */}
        {!fetching && feedPosts.length === 0 ? (
          <SuggestedUsers card />
        ) : (
          <Fragment>
            {/* Show ra các feed dc fetching về */}
            <Feed />
            {/* Thanh sidebar gợi ý follow người dùng */}
