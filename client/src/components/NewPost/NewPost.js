...
const NewPost = ({ file, hide }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      // Giải thoát cho object url của image
  ...
  useEffect(() => {
    (async function () {
      try {
        // Fetching các filters cho image
  ...
  const renderSections = () => {
    // Xét xem đang ở section filter hay section điền form
  ...
  return (
    <section className="new-post">
      {/* TH active section khác details === đang ở filters section */}
